insert or ignore into core_user(id, firstname, lastname, username, tenant, last_modified) values ('00000000-0000-0000-0000-000000000ace','admin','','admin',0,datetime('now'));
insert or ignore into core_usersecurity(tenant, userid, pwdhash, pwdhashsha512) values (0,'00000000-0000-0000-0000-000000000ace','jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=','l/DFJ5yg4oh1F6Qp7uDhBw==');
insert or ignore into core_usergroup(tenant, userid, groupid, ref_type) values (0,'00000000-0000-0000-0000-000000000ace','cd84e66b-b803-40fc-99f9-b2969a54a1de',0);

insert or ignore into tenants_tenants(id, alias, name, creationdatetime, owner_id) values (0,'localhost','Intranet portal', datetime('now'), '00000000-0000-0000-0000-000000000ace');
update tenants_tenants set id = 0 where id = 1;
insert or ignore into tenants_quota (tenant, name, max_file_size, max_total_size, active_users) values (-1, 'Default', 100, 102400, 100000);
