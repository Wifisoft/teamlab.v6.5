...
namespace ASC.Web.UserControls.Bookmarking.Common.Presentation
{
    ...
    public class BookmarkingServiceHelper : BookmarkingSessionObject<BookmarkingServiceHelper>
    {
        ...
        {
            return _service.GetTagsCloud();
        }

        public IList<Tag> GetRelatedTagsCloud(long BookmarkID)
        {
            return _service.GetRelatedTagsCloud(BookmarkID);
        }

        public IList<Tag> GetFavouriteTagsCloud()
        {
            return _service.GetFavouriteTagsCloud();
        }

        public IList<Tag> GetTagsSortedByName()
        {
            return _service.GetTagsSortedByName(FirstResult, MaxResults);
        }

        public IList<Tag> GetMostPopularTags()
        {
            return _service.GetMostPopularTags(FirstResult, MaxResults);
        }

        public int GetTagsCount()
        {
            return _service.GetTagsCount();
        }
        ...
        {
            var visiblePageCount = (int) itemsCount/MaxResults + 1;
        ...
        {
            return _service.GetMostRecentTags(FirstResult, MaxResults);
        }
