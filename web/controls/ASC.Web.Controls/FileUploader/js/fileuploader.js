...
ASC.Controls.FileUploader = function(config) {
    ...
    if (config.OverAllProcessHolder != null) {
        jq(config.OverAllProcessHolder).html("<table cellpadding='5' cellspacing='0' width='100%' style='padding:10px 0;' class='describeText'><tr><td width='100'>" + config.OverallProgressText + ": </td><td>" + '<div style="margin-top: 1px;" class="{0}"><div></div></div>'.format(config.OverAllProcessBarCssClass) + "</td><td class='fu_percent' width='20'></td></tr></table>");
        ...
        this.SetFormData = function(scope) {
            ...
            var au = new AjaxUpload(scope.ButtonID, {
                ...
                onChange: function(file, extension) {
                    ...
                    _renderUploadItem({ UploadId: this.Utx,
                        CurrentFile: file,
                        TotalBytes: 0,
                        Progress: 0,
                        HasDelete: true,
