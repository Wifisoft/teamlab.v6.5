...
var FileHtml5Uploader = new function() {
    ...
    this.InitHtml5Uploader = function() {
        ...
        setTimeout(function() {
            ...
            jq('#' + FileHtml5Uploader.config.UploadButtonID).html("<div id='fu_multi_container' style='overflow: hidden; width: 128px; height: 20px; cursor: pointer;'></div><a id='fu_button_select' class='grayLinkButton' href='javascript:void(0);' style='width: 105px; margin: -20px 0 5px 0; cursor: pointer;' title='" + buttonText + "'>" + buttonText + "</a>");
