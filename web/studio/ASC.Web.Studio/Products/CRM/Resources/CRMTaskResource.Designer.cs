...
namespace ASC.Web.CRM.Resources {
    ...
    public class CRMTaskResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Выберите CSV файл.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Сопоставьте колонки из своего файла с соответствующими полями в TeamLab CRM. Пожалуйста, обратите Ваше внимание на то, что для правильного импорта задач вы должны найти соответствие по крайней мере полям &apos;Название задачи&apos;, &apos;Ответственный&apos;, &apos;Срок выполнения&apos; из Teamlab CRM столбцам из вашего файла. Только после этого Вы сможете перейти к следующему шагу. Поля содержащие дату должны быть заданы форматом {0}..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Import of tasks can take several minutes depending on the amount of your data. You will be informed when it is done..
        /// </summary>
