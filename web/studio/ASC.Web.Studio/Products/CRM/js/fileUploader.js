...
ASC.CRM.FileUploader = (function($) {
    ...
    {
        jq(".pm-ajax-info-block span").text(jq.format(CRMJSResources.UploadingProgress, data.CurrentFile)); 
    },
    ...
    activateUploader: function() {
        ...
        var FileUploaderConfig = {
                ...
                AddFilesText : CRMJSResources.UploadFile,
                SelectFilesText : CRMJSResources.UploadFile,
                OverallProgressText : CRMJSResources.OverallProgress
            };
