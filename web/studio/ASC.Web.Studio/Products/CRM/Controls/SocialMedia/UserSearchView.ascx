...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserSearchView.ascx.cs"
    Inherits="ASC.Web.CRM.Controls.SocialMedia.UserSearchView" EnableViewState="false" %>
<div id="divSMUserSearchContainer" style="display: none;">
    <ascwc:Container ID="_ctrlUserSearchContainer" runat="server">
        <Header>
