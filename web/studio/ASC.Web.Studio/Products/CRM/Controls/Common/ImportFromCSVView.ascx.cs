...
namespace ASC.Web.CRM.Controls.Common
{
    public class ImportFileHandler : IFileUploadHandler
    {
        public FileUploadResult ProcessUpload(HttpContext context)
        {
            ...
            fileUploadResult.Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes( jObject.ToString()));
    ...
    public partial class ImportFromCSVView : BaseUserControl
    {
        ...
        public static String Location { get { return PathProvider.GetFileStaticRelativePath("Common/ImportFromCSVView.ascx"); } }
