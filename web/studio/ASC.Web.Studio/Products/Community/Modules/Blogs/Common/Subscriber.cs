...
namespace ASC.Web.Community.Blogs
{
    ...
    public class Subscriber 
    {
        ...
        public string RenderCommentsSubscription(bool isSubscribe, Guid postID)
        {
            ...
            sb.AppendFormat("<a class='linkAction"+(SetupInfo.WorkMode == WorkMode.Promo?" promoAction":"")+"' title='{3}' href=\"#\" onclick=\"BlogSubscriber.SubscribeOnComments('{0}', {1}); return false;\">{2}</a>",
                postID,
                (isSubscribe ? 1 : 0),
        ...
        public string RenderPersonalBlogSubscription(bool isSubscribe, Guid userID)
        {
            ...
            sb.AppendFormat("<a class='linkAction" + (SetupInfo.WorkMode == WorkMode.Promo ? " promoAction" : "") + "' title='{3}' href=\"#\" onclick=\"BlogSubscriber.SubscribeOnPersonalBlog('{0}', {1}); return false;\">{2}</a>",
                userID, 
                (isSubscribe ? 1 : 0), 
        ...
        public string RenderNewPostsSubscription(bool isSubscribe)
        {
            ...
            sb.AppendFormat("<a class='linkAction" + (SetupInfo.WorkMode == WorkMode.Promo ? " promoAction" : "") + "' title='{2}' href=\"#\" onclick=\"BlogSubscriber.SubscribeOnNewPosts({0}); return false;\">{1}</a>",
                (isSubscribe ? 1 : 0),
