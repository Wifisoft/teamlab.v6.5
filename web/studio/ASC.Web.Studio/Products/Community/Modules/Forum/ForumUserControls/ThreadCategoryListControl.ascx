...
<asp:Repeater ID="_categoryRepeater" runat="server">
    <ItemTemplate>
       <div class="clearFix">
            <div class="headerBase" style="padding: 25px 0px 15px 0px; width: 100%; overflow: hidden;"
            ...
            <asp:Repeater ID="_threadRepeater" runat="server">
                <ItemTemplate>                
                    <div class="<%#RenderThreadCSSClass(Container.ItemIndex, (Container.DataItem as ASC.Forum.Thread))%> clearFix borderBase" style="padding:5px 0px; margin-top:-1px; border-right:none; border-left:none;width: 100%;overflow:hidden;">
                            ...
                            <tr valign="top">
                                ...
                                <td style="width:40%; padding-top:8px;">
                                    <div style="padding-right: 5px; width: 285px; word-wrap: break-word;">
                                        <a class="linkHeaderLight" href="<%#_settings.LinkProvider.TopicList((int)Eval("ID"))%>"
                                            title="<%#HttpUtility.HtmlEncode((string)Eval("Title"))%>"><%#HttpUtility.HtmlEncode((string)Eval("Title"))%></a>
                                    </div>
                                    <div class="textMediumDescribe" style="padding: 2px 0px; width: 285px; word-wrap: break-word;"><%#HttpUtility.HtmlEncode((string)Eval("Description"))%></div>                
                                </td>
