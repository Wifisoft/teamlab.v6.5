...
<asp:Panel runat="server" ID="passwordSetter" Visible="false">
    ...
    <div class="clearFix" align="center" style="margin-top: 20px;">
        <asp:Button runat="server" Text="<%$ Resources:Resource, EmailAndPasswordOK %>"
            CssClass="baseLinkButton" Style="width: 100px;" OnClick="LoginToPortal" />
    </div>
</asp:Panel>
<asp:Panel runat="server" ID="emailChange" Visible="false">
    ...
    <div id="emailInputContainer">
        ...
        <div class="clearFix" style="margin-top: 15px;">
            ...
            <div style="margin-top: 3px;">
                <input type="text" id="email1" value="" style="width: 360px;" name="emailInput" class="pwdLoginTextbox" />
            </div>
        </div>
        <%--ReEmail--%>
        <div class="clearFix" style="margin-top: 15px;">
            ...
            <div style="margin-top: 3px;">
                <input type="text" id="email2" value="" style="width: 360px;" name="reEmailInput"
                    class="pwdLoginTextbox" />
            </div>
        </div>
        <div class="clearFix" align="center" style="margin-top: 20px;">
            <asp:Button ID="btChangeEmail" runat="server" Text="<%$Resources:Resource, ChangeEmail %>"
                CssClass="baseLinkButton" OnClientClick="btChangeEmailOnClick(); return false;" />
        </div>
    </div>

    <script type="text/javascript">
        function btChangeEmailOnClick() {
