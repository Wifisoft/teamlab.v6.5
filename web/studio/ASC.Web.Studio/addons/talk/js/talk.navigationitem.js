  ...
  ASC.Controls.NavigationItem = {
    ...
    updateValue : function (value) {
      ...
      if (o) {
        ...
        jQuery('.top-item-box.talk')[value > 0 ? 'addClass' : 'removeClass']('has-led');
      }
    },
...
if (!ASC.Controls.JabberClient) {
  ASC.Controls.JabberClient = {
    ...
    params          : 'ontouchend' in document ? '' : 'width=1000,height=600,status=no,toolbar=no,menubar=no,resizable=yes,scrollbars=no',
    pathCmdHandler  : '',
    pathWebTalk     : '',
