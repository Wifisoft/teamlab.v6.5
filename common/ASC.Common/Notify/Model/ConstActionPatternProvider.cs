...
{
    public sealed class ConstActionPatternProvider : IActionPatternProvider
    {
        private readonly Dictionary<INotifyAction, Dictionary<string, IPattern>> _Accords = new Dictionary<INotifyAction, Dictionary<string, IPattern>>();

        private readonly Dictionary<INotifyAction, IPattern> _DefaultPatterns = new Dictionary<INotifyAction, IPattern>();


        public ConstActionPatternProvider(KeyValuePair<INotifyAction, KeyValuePair<string, IPattern>>[] accordings)
        {
