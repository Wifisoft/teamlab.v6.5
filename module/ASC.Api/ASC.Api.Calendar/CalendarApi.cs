...
namespace ASC.Api.Calendar
{
    ...
    public class CalendarApi : IApiEntryPoint
    {
        ...
        public void ManageSubscriptions(List<SubscriptionState> states)
        {
            var viewSettings = _dataProvider.GetUserViewSettings(SecurityContext.CurrentAccount.ID, states.ConvertAll<string>(s => s.id));
