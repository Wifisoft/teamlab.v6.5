...
namespace ASC.Api.CRM
{
    public partial class CRMApi
    {
        ...
        /// <summary>
        ///  Групповое создание контактной информации
        /// </summary>
        ///<short>Групповое создание контактной информации</short> 
        ///<param name="items">Контактная информация</param>
        ///<category>Contacts</category>
        ///<exception cref="ArgumentException"></exception>
        /// <returns>
        ///   Contact information
        ...
        /// <summary>
        ///  Групповое обновление контактной информации
        /// </summary>
        ///<short>Групповое обновление контактной информации</short> 
        ///<param name="items">Контактная информация</param>
        ///<category>Contacts</category>
        ///<exception cref="ArgumentException"></exception>
        /// <returns>
