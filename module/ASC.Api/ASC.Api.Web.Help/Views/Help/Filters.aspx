...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <p>
        I.e. the request <a href="<%=Url.DocUrl("people", "get", "api/1.0/people")%>">api/1.0/people</a> can be appended with several parameters, 
        for example <a href="<%=Url.DocUrl("people", "get", "api/1.0/people")%>">api/1.0/people?startIndex=10&amp;count=25</a>
        </p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="views-field-body">
                    ...
                    <a href="<%=Url.DocUrl("people", "get", "api/1.0/people")%>">api/1.0/people?sortBy=userName&amp;sortOrder=descending</a>                 
                </td>
            </tr>
            <tr>
                <td class="views-field-title">
            ...
            <tr>
                ...
                <td class="views-field-body">
                    ...
                    <a href="<%=Url.DocUrl("people", "get", "api/1.0/people")%>">api/1.0/people?filterBy=userName&amp;filterOp=startsWith&amp;filterValue=Alex</a>                 
                </td>
            </tr>
            <tr>
                <td class="views-field-title">
