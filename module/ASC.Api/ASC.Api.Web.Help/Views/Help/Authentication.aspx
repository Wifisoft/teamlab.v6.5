...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ol>
        <li>Send POST request, containing two parameters: <strong>userName</strong> and <strong>password</strong>, to the <a href="<%=Url.DocUrl("authentication", "post", "api/1.0/authentication")%>">api/1.0/authentication</a> address
   <h4>Request</h4>
<pre><code>POST /api/1.0/authentication.json HTTP/1.1
...
<pre><code>GET api/1.0/people/@self.json HTTP/1.1
Host: portal.teamlab.com
Accept: application/json,application/xml
Accept-Encoding: gzip, deflate
