...
namespace AppLimit.CloudComputing.SharpBox.StorageProvider.DropBox.Logic
{
    ...
    internal class DropBoxRequestParser
    {
        ...
        private static readonly CachedDictionary<KeyValuePair<string, string>> SessionHashStorage = new CachedDictionary<KeyValuePair<string, string>>("dropbox-requests-hash",
                                                                                                                                                       System.Web.Caching.Cache.NoAbsoluteExpiration,
                                                                                                                                                       TimeSpan.FromMinutes(30), (x) => true);
